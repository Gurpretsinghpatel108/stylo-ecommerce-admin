...
//       // ✅ Fixed here: correctly access response data
...
//     setSelectedCategory(sub.categoryId ? sub.categoryId._id : "");
//     setShowAddBox(true);
//     setEditId(sub._id);
//   };
...
//   // Filter subcategories: only show those whose category still exists
